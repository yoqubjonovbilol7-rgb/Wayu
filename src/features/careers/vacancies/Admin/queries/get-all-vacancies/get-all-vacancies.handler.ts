...
export class GetAllVacanciesHandler implements IQueryHandler<GetAllVacanciesQuery> {
    async execute(query: GetAllVacanciesQuery): Promise<CareerVacancyResponse[]> {
        ...
        return plainToInstance(CareerVacancyResponse, vacancies, {excludeExtraneousValues: true});
    }
}
